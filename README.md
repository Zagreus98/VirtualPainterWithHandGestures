...
* **#4** Trei degete ridicate (degetul mare si celelalte degete de langa) - UNDO PROBLEMA: se confunda cu selectia zic sa folosim altceva
* **#5** Pace (2 degete impreunate) pentru - SELECTIE
* **#6** Open
* **#7** Closed 
